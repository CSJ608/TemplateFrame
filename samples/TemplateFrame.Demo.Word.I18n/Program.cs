...
// i18n 演示（Word 插件，迭代 12，消息层）：
//   同一套操作在 zh-CN（中文默认）与 en（英文）两种文化下执行，展示库的校验/异常消息随 CurrentUICulture 自动切换；
//   文档内容 i18n（中英模板：占位符 / 页码 / 版式文本 / 表头按语言）见独立 Demo：samples/TemplateFrame.Demo.Word.ContentI18n。
