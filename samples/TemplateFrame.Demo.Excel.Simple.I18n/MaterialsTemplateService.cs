...
/// <summary>
/// 根集合版物料场景服务（i18n 演示）：TData 直接就是 <see cref="List{T}"/>（表格 DataPath 留空），
/// 无需再包一层容器对象即可 BuildTemplate / Validate / Fill / Parse；
/// 与 <see cref="MaterialsTemplateService"/> 相同的中英表头 + 定义名回读（语言无关）。
/// </summary>
